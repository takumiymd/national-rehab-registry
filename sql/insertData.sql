...
(8002, 'Alcohol use disorder', 'Supervision is required in case self harm', 2002, 4002),
(8003, 'Opioid use disorder', 'Caretaker must be present when sharp objects are present', 2003, 4003),
